...
import { ThemeName } from "@/config/thems";
...
export const useThemeStore = create<ThemeStoreState>()(
  persist(
    (set) => ({
      ...
      setTheme: (theme) => set({ theme }), //*AppThemeProvider listens to the theme value changing, and add this value to the bidy, to get the them colors from the theme.scss file
