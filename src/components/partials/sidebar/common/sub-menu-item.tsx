...
const SubMenuItem = ({ subItem, trans }: { subItem: any; trans: any }) => {
  ...
  return (
    <LockLink href={subItem.href} subItem={subItem} trans={trans}>
      <div
        className={cn(
          "text-sm capitalize  font-normal flex gap-3 items-center transition-all duration-150 rounded hover:text-theme-color  ",
          {
            " text-theme-color   ": isLocationMatch(subItem.href, locationName),
