    ...
    <>
      {!collapsed || hovered ? (
        <div
          ...
          className={cn(
            "flex  text-default-700 group font-medium text-sm capitalize px-[10px] py-3 rounded cursor-pointer transition-all duration-100 hover:bg-theme-color hover:text-primary-foreground group",
            {
              "bg-theme-color  text-primary-foreground":
                activeSubmenu === index,
            }
          )}
        >
