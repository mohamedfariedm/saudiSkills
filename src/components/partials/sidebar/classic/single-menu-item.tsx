    ...
    <Link href={href}>
      <>
        {!collapsed || hovered ? (
          <div
            className={cn(
              "flex  gap-3 group  text-default-700 dark:text-default-950  font-medium  text-sm capitalize px-[10px] py-3 rounded cursor-pointer hover:bg-theme-color primary hover:text-primary-foreground",
              {
                "bg-theme-color text-primary-foreground ": isLocationMatch(
                  href,
                  locationName
                ),
              }
